...
$(document).ready(
    function(){
        $('#all li ').hover(
            function(){
                $(this).css("border-bottom","1px solid #0099cc");
            },
            function(){
...
(function($) {
    $.fn.parallaxSlider = function(options) {
        ...
        return this.each(function() {
            ...
            //the main slider
            var $pxs_slider     = $('.slider-u',$pxs_container),
            //the elements in the slider
                $elems          = $pxs_slider.children(),
            //total number of elements
                total_elems     = $elems.length,
            //the navigation buttons
                $pxs_next       = $('.slider_next',$pxs_container),
                $pxs_prev       = $('.slider_prev',$pxs_container),
            //the bg images
                $pxs_bg1        = $('.slider_bg1',$pxs_container),
                $pxs_bg2        = $('.slider_bg2',$pxs_container),
                $pxs_bg3        = $('.slider_bg3',$pxs_container),
            //current image
                current         = 0,
            //the thumbs container
                $pxs_thumbnails = $('.slider_thumbnails',$pxs_container),
            //the thumbs
